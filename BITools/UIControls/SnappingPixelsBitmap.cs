...
{
    public class SnappingPixelsBitmap : UIElement
    {
        public SnappingPixelsBitmap()
        {
        ...
        public static readonly DependencyProperty SourceProperty = DependencyProperty.Register(
            "Source",
            typeof(BitmapSource),
            typeof(SnappingPixelsBitmap),
            new FrameworkPropertyMetadata(
                null,
                FrameworkPropertyMetadataOptions.AffectsRender |
                FrameworkPropertyMetadataOptions.AffectsMeasure,
                new PropertyChangedCallback(SnappingPixelsBitmap.OnSourceChanged)));
        ...
        {
            SnappingPixelsBitmap bitmap = (SnappingPixelsBitmap)d;
