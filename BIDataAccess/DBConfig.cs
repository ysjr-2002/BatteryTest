...
namespace BIDataAccess
{
    public class DBConfig
    {
        ...
        {
            return string.Concat("metadata=res://*/entities.Model1.csdl|res://*/entities.Model1.ssdl|res://*/entities.Model1.msl;provider=System.Data.SqlClient;provider connection string=\"",
                "Data Source=" + DataSource + ";Initial Catalog=" + DataBase + ";User ID=" + UserId + ";Password=" + PassWord + ";MultipleActiveResultSets=True;App=EntityFramework;\"");
        }
    }
}
